...
function PrettyPrintJsonObject(obj, indent, addComma, isArray, isPropertyContent){
	return ProcessObject(obj, indent, addComma, isArray, isPropertyContent);
}
function ProcessObject(obj, indent, addComma, isArray, isPropertyContent){
  ...
  if(IsArray(obj)){
    if(obj.length == 0){
      ...
      html += "<span class='ArrayBrace'>[</span>"+clpsHtml;
